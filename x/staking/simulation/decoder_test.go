...
func TestDecodeStore(t *testing.T) {
	...
	ubd := types.NewUnbondingDelegation(delAddr1, valAddr1, 15, bondTime, math.OneInt(), address.NewBech32Codec("cosmosvaloper"), address.NewBech32Codec("cosmos"))
	red := types.NewRedelegation(delAddr1, valAddr1, valAddr1, 12, bondTime, math.OneInt(), math.LegacyOneDec(), address.NewBech32Codec("cosmosvaloper"), address.NewBech32Codec("cosmos"))
